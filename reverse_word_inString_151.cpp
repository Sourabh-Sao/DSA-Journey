...
string reverse(string s){
    int n=s.size();
    reverse(s.begin(), s.end());  //first , reversing the string
    string ans="";
    ...
    return ans.substr(1);   //substring ans from 1 because we have already added 1 white space at first to remove this we create a substring
}
